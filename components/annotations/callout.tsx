    ...
    return (
      <>
        ...
        <div
          ...
          className="w-fit border bg-editorGroupHeader-tabsBackground border-editorGroup-border rounded px-1 relative my-1 whitespace-break-spaces prose-p:my-1 prose-p:mx-2 select-none"
        >
          <div
